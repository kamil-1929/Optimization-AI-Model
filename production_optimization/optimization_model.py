...
def run_optimization():
    ...
    # LpMaximize indicates that we are trying to maximize the objective function
    model = pl.LpProblem("Maximize_Profit", pl.LpMaximize)

    # Define decision variables
    # The lowBound parameter ensures that the variables cannot take negative values
    ...
    # The coefficients correspond to the profit generated by each product
